 ...
 * Time: 06:10
 */
if ( class_exists( 'WC_Payment_Gateway' ) && ! class_exists( 'Tendopay_Gateway' ) ) {
	class Tendopay_Gateway extends WC_Payment_Gateway {
		const GATEWAY_ID = "tendopay";

		function __construct() {
			$this->id         = Tendopay_Gateway::GATEWAY_ID;
